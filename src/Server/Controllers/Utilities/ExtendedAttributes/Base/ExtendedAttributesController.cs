...
using BlazorHero.TraderWebApp.Application.Features.ExtendedAttributes.Commands.Delete;
...
namespace BlazorHero.TraderWebApp.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
