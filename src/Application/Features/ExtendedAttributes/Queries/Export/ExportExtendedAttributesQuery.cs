...
using BlazorHero.TraderWebApp.Application.Specifications.ExtendedAttribute;
...
namespace BlazorHero.TraderWebApp.Application.Features.ExtendedAttributes.Queries.Export
{
